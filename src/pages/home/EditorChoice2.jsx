      ...
      <Container>
        ...
        <div className="flex flex-col md:flex-row  gap-4 mt-4">
          <div className="w-full  md:w-2/5 mx-auto">
            <article className="relative h-60 md:h-[500px] w-full isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 mb-7 pb-8 pt-80 sm:pt-48 lg:pt-80">
              <img
                src="/public/idm.png"
                alt=""
            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="h-60 w-full md:w-60 rounded-xl overflow-hidden bg-repeat-round relative bg-gradient-to-b from-transparent to-slate-900">
                ...
                <img
                  ...
                  alt=""
                />
                <button className="absolute left-4 bottom-4 font-semibold text-lg text-white">
          ...
          <div className="w-full  md:w-3/5 grid grid-cols-1 md:grid-cols-3 gap-6 mx-auto">
            <div className="h-60 w-full md:w-60 rounded-xl overflow-hidden bg-repeat-round relative bg-gradient-to-b from-transparent to-slate-900">
              <img
                className="absolute object-fill h-full w-full opacity-60"
                src="/pp.png"
