...
const SliderCatagory = () => {
  ...
  return (
    <div className="md:w-full w-[22rem] md:max-w-[78rem] text-center mx-auto text-slate-500 my-20 px-7">
      <Slider {...settings}>
        <div>
          <button className=" w-32 md:w-56 mx-2 h-32 aspect-square md:h-48 hover:bg-indigo-100 bg-slate-50 rounded-md flex flex-col justify-center items-center gap-2 border border-slate-300 dark:border-slate-500 dark:bg-slate-700 hover:dark:bg-slate-800 dark:text-slate-100 bg-transparent dark:bg-transparent">
